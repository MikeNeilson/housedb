...
TimeseriesDto::TimeseriesDto(const string &name, const string &interval_offset,
                             const vector<TimeseriesDto::triple> &values) {
    this->name = name;
    this->interval_offset = interval_offset;
    this->values = values;
}
...
TimeseriesDto::TimeseriesDto(const string &name, const string &interval_offset,
                             vector<TimeseriesDto::triple>&& values) {
    this->name = name;
    this->interval_offset = interval_offset;
...
TimeseriesDto::operator std::string() const {
    stringstream ss;
    ss << this->name << "{interval_offset=" << this->interval_offset << ",units="
       << this->units << ",# of values=" << this->values.size() << "}";
    return ss.str();
}
}  // namespace dto
}  // namespace gardendb
